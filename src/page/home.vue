    ...
    <div ref="wrapper" class="list-wrapper">
      <div class="scroll-content">
        ...
        <div class="navs">
          <div
            class="banner-item"
            v-for="(type, typeIndex) in merchantTypes"
            :key="typeIndex"
            @click.stop="viewMerchantList(type.code, type.name)"
          >
        ...
        <div class="activities" v-if="activities && activities.length > 0">
          ...
          <div class="content">
            <div
              ...
              :key="activityIndex"
              @click.stop="viewActivity(activity.url)"
            >
        ...
        <div class="merchants" v-if="hotMerchants.length > 0">
          ...
          <div class="content">
            <div
              class="item"
              v-for="(merchant, merchantIndex) in hotMerchants"
              :key="merchantIndex"
              @click.stop="viewMerchantDetail(merchant.mer_id)"
            >
              <div class="logo">
                <img
                  v-if="merchant.pic"
                  class="normal"
                  :src="merchant.pic | upload"
                />
                <img
                  class="default"
                  src="../assets/img/base/icon_goods_default@2x.png"
                  v-else
                />
              </div>
  ...
  methods: {
    getInitData() {
      ...
      this.$http
        ...
        .then(
          axios.spread(
            (bannerRes, merchantTypesRes, activitiesRes, hotMerchantsRes) => {
    ...
    initScroll() {
      ...
      this.$refs.wrapper.style.minHeight = `${
        getRect(this.$refs.wrapper).height + 1
      }px`;
      let options = {
        probeType: 1,
        click: true,
    ...
    viewMerchantList(pCode, typeName) {
      this.$router.push({
        name: "merchant",
        params: { pCode: pCode, typeName: typeName },
      });
    },
    ...
    goParking() {
      window.location.href =
        "http://yanshi.yklsq.etonepay.com/parking/#/home?phone=&member=114706053265883136&openid=oQtrs58bNzOJQC_-VlOHOZ1hOYjI&point=7881&parkingId=1";
    },
  },
};
</script>
